...
int main()
{
 ...
 return 0; // Wenn das Programm die Zahl 100 erreicht hat, wird als return der Wert 0 ausgegeben, welcher bedeutet, dass das Programm ordnungsgemäß und erwartet ausgeführt wurde
}
